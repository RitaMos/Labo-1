...
\begin{figure}[htbp]
    ...
    % Primera fila: 3 imágenes
        ...
        \caption{Ripple y $V_{medio}$ medido a $f = 1kHz$.}
         \label{fig:a_1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption{Ripple y $V_{medio}$ medido a $f = 25kHz$. En ltspice $V_{medio} = 6,05V$}
        \label{fig:a_25}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption{Ripple y $V_{medio}$ medido a $f = 75kHz$. En ltspice $V_{medio} = 6,69V$}
         \label{fig:a_75}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        ...
        \caption{Ripple y $V_{medio}$ medido a $f = 100kHz$. En ltspice $V_{medio} = 7,05V$}
         \label{fig:a_100}
    \end{subfigure}
        \begin{subfigure}[b]{0.31\textwidth}
        \centering
...
Otra diferencia observada, fue que a una $f = 1kHz$ no se cumplió la tendencia del valor medio de tensión de salida. En este caso se observó una salida mucho mayor, a las vistas a altas frecuencias. Esto se puede explicar debido a que al tener mayor tiempo de carga, el núcleo se puede saturar bridando mayores corrientes de salida.\par
...
\subsection{Barrido de duty cycle}

...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{q_wo_6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{resonan_6.png}
...
Nótese que la figura~\ref{fig:desfasaje_f0} sirve simultáneamente para 
identificar $f_0$ por el desfasaje y para extraer las amplitudes del Método B, 
lo que ilustra la ventaja práctica de este método al concentrar ambas 
mediciones en una única captura.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{fcorte_6.png}

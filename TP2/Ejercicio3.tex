...
%%%%%%CAMBIADO PARA MAYOR ESPACIO%%%%%%

\begin{figure}[H]
    \centering
    % Reducimos el espacio entre columnas para que quepan ambas tablas
    \setlength{\tabcolsep}{3pt} 
    
    % --- TABLA DE INDUCTANCIAS ---
    \begin{minipage}{0.49\textwidth}
        ...
        \begin{tabular}{ccccc}
            ...
            \bottomrule
        \end{tabular}
        \captionof{figure}{Inductancias y valores parásitos.}
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        \begin{tabular}{ccccc}
            ...
            \bottomrule
        \end{tabular}
        \captionof{figure}{Capacitancias y valores parásitos.}
...
\begin{centering}
	...
	\node[ground] at (1.5, 2){};
	\node[circ] at (2.5, 4){};
	\node[shape=rectangle, minimum width=0.965cm, minimum height=0.215cm] at (2.5, 4.5){} node[anchor=north west, align=left, text width=0.577cm, inner sep=6pt] at (2, 4.625){out};
	\draw (1.5, 4) -- (2.5, 4);
	\draw (5.25, 4) -- (6.25, 4);
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (4.5, 4.75){};
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (4, 4.75){} node[anchor=north west, align=left, text width=1.077cm, inner sep=6pt] at (3.25, 5){$ 19.1 m\Omega $};
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (7.25, 3){} node[anchor=north west, align=left, text width=1.077cm, inner sep=6pt] at (6.5, 3.25){$ 39.26 \mu H $};
\end{tikzpicture}
...
\end{equation*}
tomando los $ C=8,3 nF $ (valor nominal), f=282 kHz (la frecuencia de natural del circuito) y D el valor medido para la frecuencia natural mencionada. Esto resultó en un valor de ESR de $ 1,2 \Omega $, y así en el modelo que se observa en la figura \ref{modeloTeoricoC}
...
\begin{centering}
	...
	\draw (5.25, 4) -- (6.25, 4);
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (4.5, 4.75){};
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (4.25, 3.5){} node[anchor=north west, align=left, text width=1.077cm, inner sep=6pt] at (3.5, 3.75){$ 1.2 \Omega $};
	\node[shape=rectangle, minimum width=1.465cm, minimum height=0.465cm] at (7.5, 3){} node[anchor=north west, align=left, text width=1.077cm, inner sep=6pt] at (6.75, 3.25){$ 8.2 nF $};

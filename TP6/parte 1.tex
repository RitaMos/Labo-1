...
Para acotar el error, debido a que los mismos decrecen en gran medida, asumo que $P_n \propto \frac{1}{n}$ por lo que $p_n = \frac{k}{n^2}$. Esta K se puede calcular usando un valor conocido como $P_2$, por lo que $K=4P_2$. Luego con eso el error viene dado por :$\Delta THD=
\sqrt{
\frac{4P_2}{P_1}
\sum_{n=N+1}^{\infty}\frac{1}{n^2}
}$.\par

Luego con los valores de la tabla se calcularon las distorsiones armónicas para la FFT y el analizador de espectro. Al mismo tiempo se calculó el error asociado a la medición del analizador de espectro. Finalmente se llegó a:

...
\noindent Al agregar $R_{BE}$ el tiempo de subida $t_{PLH}$ disminuye porque la carga almacenada en la base se descarga más rápido 
. A cambio, disminuye el CTR (menor corriente de colector para igual $I_F$), lo cual equivale a operar con una

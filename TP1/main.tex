...
\]
    ...
    \subsection{Parte práctica}
        \subsubsection*{a) Diagrama de Bode}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.5\linewidth]{2.2simulacion.png}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.5\linewidth]{2.2bodeTeorico.png}
                \caption{Diagrama de BODE teórico del filtro pasaaltos.}
                \label{fig:pasaaltosTeorico}
            \end{figure}

            \begin{figure}[H]
                \centering
                \includegraphics[width=0.5\linewidth]{2.2bodeMedido.png}
        ...
        \\ Para f=50 kHz, el tiempo que tiene el capacitor para cargarse es aun menor, y dado que la
        ...
        \\ *********************** LO DEL SOBREPICO INICIAL CREO QUE ES UNA COSA DE LA SIMULACION, NO SE SI SE VERIA ASI EN EL OSCILOSCOPIO.
        SIGO COMPLETANDO CUANDO TENGA LA MEDICION, Y AHI CAMBIO LAS FOTOS DE LA SIMULACION POR LAS DEL LABO.   
            ...
            \begin{figure}[H]
                ...
                \begin{minipage}{0.48\textwidth}
                    \centering
                    \includegraphics[width=\linewidth]{item2_triangular100k.png}
                    \caption*{f = 100 kHz}
                \end{minipage}
                
                \vspace{0.4cm}
                
                % Tercera fila: 300 kHz
                \begin{minipage}{0.48\textwidth}
                    \centering
                    \includegraphics[width=\linewidth]{item2_triangular300k.png}
                    \caption*{f = 300 kHz}
                \end{minipage}

                \caption{Respuesta del filtro pasa-altos ante una señal triangular a distintas frecuencias. En azul se observa la señal de entrada y en verde la señal de salida sobre la resistencia.}

...
\end{axis}
\end{tikzpicture}
\captionof{figure}{Respuesta del filtro pasa-altos para $f = 10 f_0$.}
\label{fig:10f0}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
...
\end{axis}
\end{tikzpicture}
\captionof{figure}{Respuesta del filtro pasa-altos para $f = f_0$.}
\label{fig:f0}
\end{minipage}
...
\end{axis}
\end{tikzpicture}
\captionof{figure}{Respuesta del filtro pasa-altos para $f = \frac{f_0}{10}$.}
\label{fig:f0_10}
\end{minipage}
...
\[
V_{out}(s) \approx (sRC)\frac{k}{s^2} = \frac{kRC}{s}
\]
...
Homologamente para el tramo decreciente:
...
\caption{Respuesta del filtro pasa-altos ante una señal triangular (bajas frecuencias).}
\label{fig:item2-triangular-bajo}
\end{figure}
...
\caption{Respuesta del filtro pasa-altos ante una señal triangular (altas frecuencias).}
\label{fig:item2-triangular-alto}
\end{figure}
%%%%%nuevo%%%%%
